...
urlpatterns = [
    ...
    re_path(r'post/(?P<pk>\d+)/remove/$', views.deletepost, name='post_remove'),
    re_path(r'drafts/$', views.get_queryset, name='post_draft_list'),
    re_path(r'post/(?P<pk>\d+)/comment/$', views.add_comment_to_post , name='add_comment_to_post'),
    # re_path(r'comment/(?P<pk>\d+)/approve/$', views.comment_approve , name='comment_approve'),
    # re_path(r'comment/(?P<pk>\d+)/remove/$', views.comment_remove , name='comment_remove'),
    re_path(r'post/(?P<pk>\d+)/publish/$', views.post_publish, name='post_publish'),
    re_path(r'wall/$', views.Wall.as_view(), name='wall'),
    re_path(r'accounts/login/$', views.user_login, name='user_login'),
    re_path(r'accounts/registration/$', views.registration , name='registration'),
